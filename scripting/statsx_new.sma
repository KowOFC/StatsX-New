...
#define STATSX_MOTD_STYLE "<link rel='stylesheet' href='http://your_link/statsx.css'>"
...
new g_szBuffer[2048], g_szName[32], g_szName2[23], g_szWpn[32], g_szHudBuffer[4][1024], g_iTopNum
...
public plugin_init()
{
	...
	cvar_prefix = register_cvar("statsx_new_prefix", "&x04[StatsX New]&x01")
